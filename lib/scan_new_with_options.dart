...
class ScanNewPage extends StatefulWidget {
  const ScanNewPage({Key? key}) : super(key: key);
  @override
  _ScanNewPageState createState() => _ScanNewPageState();
}

class _ScanNewPageState extends State<ScanNewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Barcode Scanner BagBack'),
          actions: [
            IconButton(
